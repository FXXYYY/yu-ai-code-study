...
import com.study.yuaicodemother.ai.AiCodeGenTypeRoutingService;
import com.study.yuaicodemother.constant.AppConstant;
import com.study.yuaicodemother.core.AiCodeGeneratorFacade;
import com.study.yuaicodemother.core.builder.VueProjectBuilder;
import com.study.yuaicodemother.exception.BusinessException;
import com.study.yuaicodemother.exception.ErrorCode;
import com.study.yuaicodemother.exception.ThrowUtils;
import com.study.yuaicodemother.mapper.AppMapper;
...
import com.study.yuaicodemother.module.enums.ChatHistoryMessageTypeEnum;
...
import com.study.yuaicodemother.service.AppService;
import com.study.yuaicodemother.service.ChatHistoryService;
import com.study.yuaicodemother.service.ScreenshotService;
...
public class AppServiceImpl extends ServiceImpl<AppMapper, App> implements AppService {
    ...
    public Flux<String> chatToGenCode(Long appId, String message, User loginUser) {
        ...
        // 6. 调用 AI 生成代码
        Flux<String> fluxResp = aiCodeGeneratorFacade.generateAndSaveCodeStream(message, codeGenTypeEnum, appId);
        StringBuilder stringBuilder = new StringBuilder();
        return fluxResp.map(resp -> {
