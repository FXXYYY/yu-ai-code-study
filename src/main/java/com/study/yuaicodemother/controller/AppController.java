...
import com.study.yuaicodemother.annotation.AuthCheck;
import com.study.yuaicodemother.commmon.BaseResponse;
import com.study.yuaicodemother.commmon.DeleteRequest;
import com.study.yuaicodemother.commmon.ResultUtils;
import com.study.yuaicodemother.constant.AppConstant;
import com.study.yuaicodemother.constant.UserConstant;
...
import com.study.yuaicodemother.module.dto.app.*;
...
import com.study.yuaicodemother.service.ProjectDownloadService;
...
public class AppController {
    ...
    public Flux<ServerSentEvent<String>> chatToGenCode(@RequestParam Long appId,
        ...
        User loginUser = userService.getLoginUser(request);
        // 调用服务生成代码（流式）
        Flux<String> fluxResp = appService.chatToGenCode(appId, message, loginUser);
        return fluxResp
                .map(data -> ServerSentEvent.<String>builder().data(JSONUtil.toJsonStr(Map.of("d", data))).build())
